# Script for generating corpus with part of speech recognized
# Requires python3
# to run in terminal: python3 trainer.py
# requires nltk resources: punkt, averaged_perceptron_tagger
...
exampleArray = ['Wir interessieren uns für Pferde.']
